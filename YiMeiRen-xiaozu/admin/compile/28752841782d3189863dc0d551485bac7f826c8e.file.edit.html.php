<?php /* Smarty version Smarty-3.1.14, created on 2017-04-01 09:14:20
         compiled from "template\role\edit.html" */ ?>
<?php /*%%SmartyHeaderCode:2883158df6f302533a5-65138597%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '28752841782d3189863dc0d551485bac7f826c8e' => 
    array (
      0 => 'template\\role\\edit.html',
      1 => 1491038054,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2883158df6f302533a5-65138597',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.14',
  'unifunc' => 'content_58df6f302c51e0_91947843',
  'variables' => 
  array (
    'role' => 0,
  ),
...
<?php if ($_valid && !is_callable('content_58df6f302c51e0_91947843')) {function content_58df6f302c51e0_91947843($_smarty_tpl) {?>﻿<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<div class="pd-20">
  <form class="Huiform" id="loginform" action="?c=role&a=add" method="post">
    <table class="table table-border table-bordered table-bg">
      <tbody>
      <input type="hidden" value="<?php echo $_smarty_tpl->tpl_vars['role']->value[0]['id'];?>
" name="id"/>
        <tr>
          <th class="text-r" width="80">角色名称：</th>
          <td><input name="rolename" type="text" value="<?php echo $_smarty_tpl->tpl_vars['role']->value[0]['rolename'];?>
" class="input-text" id="" datatype="*1-20" nullmsg="角色名称不能为空！">
          </td>
        </tr>
        <!--<tr>
        ...
        <tr>
          ...
          <td><textarea name="description"  class="textarea" id="newpassword" placeholder="描述下角色所具有的权限" style="width:500px; height:50px; resize:none"><?php echo $_smarty_tpl->tpl_vars['role']->value[0]['description'];?>
</textarea>
          </td>
        </tr>
        <tr>
