<?php /* Smarty version Smarty-3.1.14, created on 2017-04-01 12:50:44
         compiled from "template\home\index.html" */ ?>
<?php /*%%SmartyHeaderCode:1146958de8b5c7b7188-01404617%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'efae2d1775f585875fdb8cccc898fe0084fd4731' => 
    array (
  ...
  'nocache_hash' => '1146958de8b5c7b7188-01404617',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.14',
  'unifunc' => 'content_58de8b5c847341_36617784',
  'has_nocache_code' => false,
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_58de8b5c847341_36617784')) {function content_58de8b5c847341_36617784($_smarty_tpl) {?>﻿<!DOCTYPE HTML>
...
<header class="Hui-header cl"> <a class="Hui-logo l" title="H-ui.admin v2.1" href="/">伊美人后台管理系统</a> <span class="Hui-userbox"><span class="c-white">超级管理员：admin</span> <a class="btn btn-danger radius ml-10" href="?c=login&a=logout" title="退出"><i class="icon-off"></i> 退出</a></span> <a aria-hidden="false" class="Hui-nav-toggle" id="nav-toggle" href="#"></a> </header>
  ...
  <aside class="Hui-aside" style="">
    ...
    <div class="menu_dropdown bk_2">
      <dl id="menu-user">
        ...
        <dd>
          <ul>
            <li><a _href="?c=user&a=select" href="javascript:void(0)">用户管理</a></li>
      ...
      <dl id="menu-comments">
        <dt><i class="icon-comments"></i> 评价管理<b></b></dt>
        <dd>
          <ul>
            <li><a _href="?c=comment&a=select" href="javascript:;">评价列表</a></li>
            <li><a _href="feedback-list.html" href="javascript:void(0)">意见反馈</a></li>
          </ul>
        </dd>
      </dl>
      <dl id="menu-article">
        <dt><i class="icon-edit"></i> 文章管理<b></b></dt>
        <dd>
          <ul>
            <li><a _href="?c=articletype&a=select" href="javascript:void(0)">分类管理</a></li>
            <li><a _href="?c=article&a=select" href="javascript:void(0)">文章管理</a></li>
          </ul>
        </dd>
      </dl>
      <dl id="menu-product">
        <dt><i class="icon-beaker"></i> 商品库<b></b></dt>
        <dd>
          <ul>
            <li><a _href="product-brand.html" href="javascript:void(0)">品牌管理</a></li>
            <li><a _href="?c=attr&a=select" href="javascript:void(0)">属性管理</a></li>
            <li><a _href="?c=type&a=select" href="javascript:void(0)">类型管理</a></li>
            <li><a _href="?c=category&a=select" href="javascript:void(0)">分类管理</a></li>
            <li><a _href="?c=goods&a=select" href="javascript:void(0)">商品管理</a></li>
          </ul>
        </dd>
      </dl>
      <dl id="menu-page">
      ...
      <dl id="menu-admin">
        ...
        <dd>
          <ul>
            <li><a _href="?c=role&a=select" href="javascript:void(0)">角色管理</a></li>
            <li><a _href="?c=node&a=select" href="javascript:void(0)">节点管理</a></li>
            <li><a _href="?c=admin&a=select" href="javascript:void(0)">管理员列表</a></li>
          </ul>
        </dd>
      </dl>
      <dl id="menu-system">
        ...
        <dd>
          <ul>
            ...
            <li><a _href="system-log.html" href="javascript:void(0)">修改密码</a></li>
          </ul>
        </dd>
      </dl>
    </div>
  ...
  <section class="Hui-article">
    ...
    <div id="iframe_box" class="Hui-articlebox">
      <div class="show_iframe">
        ...
        <iframe scrolling="yes" frameborder="0" src="?c=index&a=select"></iframe>
      </div>
    </div>
  </section>
</div>
