<?php /* Smarty version Smarty-3.1.14, created on 2017-04-01 08:35:56
         compiled from ".\template\type\select.html" */ ?>
<?php /*%%SmartyHeaderCode:2072258df66133421e7-89514929%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'bfff0922fdc9363911a4eb14fd208e662769b602' => 
    array (
      0 => '.\\template\\type\\select.html',
      1 => 1491035703,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2072258df66133421e7-89514929',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.14',
  'unifunc' => 'content_58df661375e9e6_27728809',
  'variables' => 
  array (
    'arr' => 0,
    'value' => 0,
...
<?php if ($_valid && !is_callable('content_58df661375e9e6_27728809')) {function content_58df661375e9e6_27728809($_smarty_tpl) {?>﻿<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<div class="pd-20">
  ...
  <div class="cl pd-5 bg-1 bk-gray mt-20">
    ...
    <a href="?c=type&a=add" class="btn btn-primary radius"><i class="icon-plus"></i> 添加类型</a></span>
...
?>
    ...
    <?php }else{ ?>
      <tr class="text-c">
        ...
        <td><u style="cursor:pointer" class="text-primary"><?php echo $_smarty_tpl->tpl_vars['value']->value['type'];?>
</u></td>
...
" class="ml-5" style="text-decoration:none"><i class="icon-edit"></i></a>
            <a title="删除" href="javascript:void(0)" onclick="if(confirm('确认删除吗')){location.href='?c=type&a=delete&id=<?php echo $_smarty_tpl->tpl_vars['value']->value['id'];?>
