...
class RoleController extends Controller{
    public function select(){
        ...
        $GLOBALS['smarty']->display("template/Role/role_list.html");
    }
    public function add(){
        if(empty($_POST)){
            $GLOBALS['smarty']->display("template/Role/role_add.html");
        }else{
            $role =new RoleModel();
            if($role->add()){
    ...
    public function edit(){
        ...
        $GLOBALS['smarty']->display("template/Role/role_edit.html");
    }
