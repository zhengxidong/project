<?php /* Smarty version Smarty-3.1.14, created on 2017-03-29 01:44:05
         compiled from ".\template\Login\login.html" */ ?>
<?php /*%%SmartyHeaderCode:2287458db11656b9531-72395261%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '2287458db11656b9531-72395261',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_58db11662ce233_22660053',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_58db11662ce233_22660053')) {function content_58db11662ce233_22660053($_smarty_tpl) {?><!DOCTYPE html>
<html>
	<head>
		<meta charset="UTF-8">
		<title>伊美人网站登录</title>
				...
				<div class="login_b_r ClearFix">
					<div class="loginul ClearFix">
						<div class="login_h2 ClearFix">
							<h2>登录伊美人</h2>
							<div class="lognrtop">
								还没有伊美人账号<a href="?c=index&a=register">快速注册</a>
							</div>
						</div>
						<div class="co">
							<div class="from">
								<form id="" action="?c=login&a=check" method="post">
									<div class="item">
									<input class="itxt" name="username" placeholder="已验证手机/邮箱/用户名" value="<?php echo $_smarty_tpl->tpl_vars['remuser']->value;?>
" >
									    <div class="err_box">
									...
									<div class="item">
										<input placeholder="验证码" id="tt" name="Code" onkeyup="send(this.value);" size="10"  class="itxt itxt_yzm onfocustxt" tabindex="3" type="text">
									...
									<div class="item item4">
										<div class="safe ClearFix">
                                            <span>
                                            <input tabindex="4" class="jdcheckbox" name="remember" id="autoLogin" checked="checked" type="checkbox">
                                            <label for="autoLogin">记住用户名</label>
                                            </span>
                                            <span class="forget-pw-safe">
                                                <a target="_blank" class="" href="?c=resetpass&a=reset">忘记密码？</a>
                                            </span>
										</div>
									</div>
									<div class="item">
