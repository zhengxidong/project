<?php /* Smarty version Smarty-3.1.14, created on 2017-03-28 13:45:01
         compiled from ".\template\Comment\user_comment.html" */ ?>
<?php /*%%SmartyHeaderCode:813958da05a608af74-79481340%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '0cd1629a73ee0ed681a48b1790cdba9501d2805c' => 
    array (
      0 => '.\\template\\Comment\\user_comment.html',
      1 => 1490708548,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '813958da05a608af74-79481340',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.14',
  'unifunc' => 'content_58da05a6271d12_45724479',
  'variables' => 
  array (
    'arr' => 0,
    'goods' => 0,
...
<?php if ($_valid && !is_callable('content_58da05a6271d12_45724479')) {function content_58da05a6271d12_45724479($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_jq')) include 'D:\\wamp\\www\\MyProject\\YiMeiRen-xiaozu\\libs\\plugins\\modifier.jq.php';
...
">
     ...
     <dl class="accountSideOption1">
      ...
      <dd>
        <ul>
          <li> <a href="?c=user&a=myorder&id=<?php echo $_smarty_tpl->tpl_vars['arr']->value['id'];?>
">我的订单</a></li>
 ...
 <!--地址管理-->
  <div class="user_address_style">
   ...
   <div class="add_address">
    <span class="name">添加评价</span>

       <form action="?c=comment&a=addcomment" method="post">
    <table cellpadding="0" cellspacing="0" width="100%">
     <tr><td class="label_name">商&nbsp;品&nbsp;&nbsp;名：</td><td>
         <span name="" style=" width:100px"/><?php echo $_smarty_tpl->tpl_vars['goods']->value[0]['goodsname'];?>
</span></td></tr>
        <tr><td class="label_name">商&nbsp;品&nbsp;&nbsp;名：</td><td>
            <span name="" style=" width:100px"/><img src="../../zoom/<?php echo smarty_modifier_jq($_smarty_tpl->tpl_vars['goods']->value[0]['microimg']);?>
" alt=""/></span></td></tr>
     <tr><td class="label_name">评价内容：</td><td><textarea name="comment" cols="" rows="" style=" width:500px; height:100px; margin:5px 0px"></textarea><i>*</i></td></tr>

        <input type="hidden" name="userid" value="<?php echo $_smarty_tpl->tpl_vars['user']->value[0]['id'];?>
"/>
        <!--<input type="hidden" name="goodsid" value="&lt;!&ndash;{$goods[0]['id']}&ndash;&gt;"/>-->
