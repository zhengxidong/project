<?php /* Smarty version Smarty-3.1.14, created on 2017-03-29 10:49:53
         compiled from ".\template\User\user_bindphone.html" */ ?>
<?php /*%%SmartyHeaderCode:1994858db6838a63b43-41776142%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '2e3eca588766f649b5c4e3a92a6a551eb24c6505' => 
    array (
      0 => '.\\template\\User\\user_bindphone.html',
      1 => 1490784590,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1994858db6838a63b43-41776142',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.14',
  'unifunc' => 'content_58db6838b23af8_32796094',
  'variables' => 
  array (
    'arr' => 0,
  ),
...
<?php if ($_valid && !is_callable('content_58db6838b23af8_32796094')) {function content_58db6838b23af8_32796094($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
            ...
            <div class="user_Account_style">
                ...
                <div id="J_main" class="m-content">
                    ...
                    <div class="m-content-hd">
                        <div class="m-page-tab"><a href="?c=user&a=reset" class="tab-item z-current" data-track="done">手机验证</a></div>
                    </div>
                    <!-- 手机验证——步骤一 -->
...
"/>
                            <div class="m-vf-item">
                                <label class="ui-label u-label">验证手机：</label>
                                <input type="text" id="phone" placeholder="输入手机号码" class="ui-input u-verification-code"/>
                            </div>
                            <div class="m-vf-item">
                                ...
                                <div class="ui-form-item-group">
                                    ...
                                    <!-- 点击后 -->
                                    <a style="display: none;" role="button" id="J_CodeBtn"><span class="second"></span>S后重新获取</a>
                                </div>
                            </div>
                            <div class="m-vf-item">
                        ...
                        <div class="success" style="text-align:center;font-size: 24px;color: #f10180;"></div>
                    </div>
                </div>
            </div>
        </div>
...
<script type="text/javascript">
    ...
    /*$("#J_getCodeBtn").click(function(){
        ...
        var username = $("#verifyusername").val();
            $.post("?c=user&a=getphoneyzm", {phone: phone,username:username}, function (msg) {
    ...
    $("#sub").click(function(){
        ...
        var phone = $("#phone").val();
        var id = $("#userid").val();
        $.post("?c=user&a=checkphoneyzm", {yzm: yzm,phone:phone,id:id}, function (msg) {
            if (msg == 0) {
