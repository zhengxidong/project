...
<div class="panel admin-panel">
  ...
  <div class="body-content">
    <form method="post" class="form-x" action="/MyProject/ALK/index.php/Admin/Column/add" enctype="multipart/form-data">
      <div class="form-group">
          <div class="label">
              <label>栏目名：</label>
          </div>
          <div class="field">
              <input type="text" class="input w50" name="columnname" data-validate="required:请输入分类" />
              <div class="tips"></div>
          </div>
      </div>
      <div class="form-group">
          ...
          <div class="field">
              <input type="text" class="input w50" name="sort" data-validate="required:请输入分类" />
