...
<form method="post" action="" id="listform">
  <div class="panel admin-panel">
    <div class="panel-head"><strong class="icon-reorder"> 探索产品列表</strong> <a href="" style="float:right; display:none;">添加字段</a></div>
    <div class="padding border-bottom">
      <ul class="search" style="padding-left:10px;">
        <li> <a class="button border-main icon-plus-square-o" href="/MyProject/ALK/index.php/Admin/QuestProductType/add"> 添加分类</a> </li>
        <li>搜索：</li>
    ...
    <table class="table table-hover text-center">
      ...
      <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
          ...
          <td><div class="button-group"> <a class="button border-main" href="/MyProject/ALK/index.php/Admin/QuestProductType/edit/id/<?php echo ($vo["id"]); ?>"><span class="icon-edit"></span> 修改</a>
...
function del(id){
	if(confirm("您确定要删除吗?")){
		location.href='/MyProject/ALK/index.php/Admin/QuestProductType/delete/id/'+id;
	}
}
