...
<div class="panel admin-panel">
  ...
  <div class="body-content">
    <form method="post" class="form-x" action="/MyProject/ALK/index.php/Admin/QuestProductType/update" enctype="multipart/form-data">
      ...
      <div class="form-group">
          ...
          <div class="field">
              <input type="text" class="input w50" name="name" value="<?php echo ($list[0]['name']); ?>" data-validate="required:请输入分类" />
              <div class="tips"></div>
          </div>
      </div>
