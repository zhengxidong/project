...
<div class="panel admin-panel">
  ...
  <div class="body-content">
    <form method="post" class="form-x" action="/MyProject/ALK/index.php/Admin/QuestProduct/update" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <div class="field">
                <select name="questproducttypeid" class="input w50">
                    <?php if(is_array($typelist)): $i = 0; $__LIST__ = $typelist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if($vo["id"] == $list[0]['questproducttypeid']): ?><option value="<?php echo ($vo["id"]); ?>" selected><?php echo ($vo["name"]); ?></option>
                            <?php else: ?>
      ...
      <div class="form-group">
          ...
          <div class="field">
              <textarea type="text" class="input w50" name="content" data-validate="required:请输入标题" /><?php echo ($list[0]['content']); ?></textarea>
              <div class="tips"></div>
          </div>
      </div>
