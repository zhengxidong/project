...
<form method="post" action="" id="listform">
  <div class="panel admin-panel">
    <div class="panel-head"><strong class="icon-reorder"> 栏目列表</strong> <a href="" style="float:right; display:none;">添加字段</a></div>
    <div class="padding border-bottom">
      <ul class="search" style="padding-left:10px;">
        <li> <a class="button border-main icon-plus-square-o" href="/MyProject/ALK/index.php/Admin/Column/add"> 添加栏目</a> </li>
      </ul>
    </div>
    <table class="table table-hover text-center">
      ...
      <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
          <td style="text-align:left; padding-left:20px;"><input type="checkbox" name="id[]" value="<?php echo ($vo["id"]); ?>" />
           <?php echo ($vo["id"]); ?></td>
          <td><?php echo ($vo["columnname"]); ?></td>
          <td><?php echo ($vo["sort"]); ?></td>
          <td><div class="button-group">
              <a class="button border-main" href="/MyProject/ALK/index.php/Admin/Column/edit/id/<?php echo ($vo["id"]); ?>"><span class="icon-edit"></span> 修改</a>
      ...
      <tr>
        ...
        <td colspan="7" style="text-align:left;padding-left:20px;">
            <a href="javascript:void(0)" class="button border-red icon-trash-o" style="padding:5px 15px;" onclick="DelSelect()"> 全部删除</a>
...
function del(id){
	if(confirm("您确定要删除吗?")){
		location.href='/MyProject/ALK/index.php/Admin/Column/delete/id/'+id;
	}
}
...
function DelSelect(){
	...
	if (Checkbox){
        ...
        var va = Checkbox.substring(1);
        location.href='/MyProject/ALK/index.php/Admin/Column/delall/id/'+va;
		/*$("#listform").submit();	*/
	}
	else{
		alert("请选择您要删除的内容!");
