...
<div class="a_left1">
<div class="a_left2">
<div class="a_left_top"><a href="Customer Service.html">防伪鉴别</a><a href="<?php echo U('Home/Feedback/add');?>">用户反馈</a><a href="<?php echo U('Home/Message/add');?>" class="c01">在线留言</a></div>
</div>
</div>
<div class="clear"></div>
</div>
...
<div class="a_rt">
<div class="a_rt_title">在线留言<span>/ Feedback</span></div>
</div>

<div class="us">
<div class="us_t"></div>
<div class="us_c">
<div class="Service_face">
<div class="kf1"><table width="100%" border="0" cellspacing="0" cellpadding="0">
            <form action="/MyProject/ALK/index.php/Home/Message/add" method="post">
              <tr>
			   ...
			   <tr>
                ...
                <td width="460"><input name="phone" type="text" id="phone" size="40" maxlength="100"  style=" height:25px;border:1px solid #ccc;" />
                  &nbsp;<font color="#CC0000">*</font></td>
              </tr>
			    <tr>
              ...
              <tr>
                <td>留言内容：</td>
                <td><textarea name="content" cols="50" rows="6" style="border:1px solid #ccc;"></textarea>
                  &nbsp;<font color="#CC0000">*</font></td>
              </tr>
              <tr>
                <td height="100">&nbsp;</td>
  ...
  <tr>
    <td width="17%"><input name="Submit" type="image" src="/MyProject/ALK/Public/Home/images/Service09.jpg" /></td>
...
<div class="us_d"></div>
<!--<div class="Service_face_main">
<div class="Service_facea">
    <?php if(is_array($arr)): foreach($arr as $key=>$value): ?><dd class="Service_facea_a">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;!&ndash;{$value['name']}&ndash;&gt;  于 &lt;!&ndash;{$value['messagedate']}&ndash;&gt; 评价说：</dd>
<dd><img src="/MyProject/ALK/Public/Home/images/Service07.jpg"/>&nbsp;<span>&lt;!&ndash;{$value['content']}&ndash;&gt;</span></dd><?php endforeach; endif; ?>
</div>
