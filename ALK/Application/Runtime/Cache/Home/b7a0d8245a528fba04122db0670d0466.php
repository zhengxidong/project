...
<div class="a_left1">
<div class="a_left2">
<div class="a_left_top"><a href="Products shows.html" class="c01">进口红葡萄酒</a><a href="Products shows1.html">进口橄榄油</a> <a href="Products shows2.html">精品展示</a> <a href="Products shows3.html">其他产品</a></div>
</div>
</div>
<div class="clear"></div>
</div>
...
<?php if(is_array($arr)): $i = 0; $__LIST__ = $arr;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="products">
<div class="products_l"><img src="/MyProject/ALK/Public/Upload/Product/<?php echo ($vo["picpath"]); ?>" width="55" height="145"/></div>
<div class="products_r">
<div class="products_rt"><?php echo ($vo["productname"]); ?></div>
<div class="products_rc">
<dd>度数：<?php echo ($vo["degree"]); ?>vol</dd>
<dd>年份：<?php echo ($vo["years"]); ?>年</dd>
<dd>产区：<?php echo ($vo["producingareas"]); ?></dd>
<dd>等级：<?php echo ($vo["grade"]); ?></dd>
</div>
<div class="products_rd"><a href="/MyProject/ALK/index.php/Home/Product/productsdetail/id/<?php echo ($vo["id"]); ?>">详情>></a></div>
</div>
