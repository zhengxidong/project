...
<div class="a_r_maint">
<div class="a_r_maint_title"><?php echo ($arr['newstitle']); ?></div>
<div class="a_r_maint_time"><span>时间：</span><?php echo (newslist($arr['newsdate'])); ?></div>
</div>

<div class="a_r_maind">
<?php echo (htmlspecialchars_decode($arr['newscontent'])); ?>
</div>
