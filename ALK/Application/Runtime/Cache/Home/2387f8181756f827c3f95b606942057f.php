...
<div class="muen_box">
    <div class="muen">
        <ul>
            ...
            <li><a href="<?php echo U('Home/QuestProduct/wineculture');?>" class="c">探秘产品<br/><span>Quest Product</span></a></li>
                ...
                <div class="a_left1">
                    <div class="a_left2">
                        <div class="a_left_top">
                            <?php if(is_array($title)): foreach($title as $key=>$value): ?><a href="/MyProject/ALK/index.php/Home/QuestProduct/quest/id/<?php echo ($value['id']); ?>" class="c01"><?php echo ($value['name']); ?></a><?php endforeach; endif; ?>
                        </div>
                    </div>
                </div>
                <div class="clear"></div>
