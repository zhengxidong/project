...
<div class="a_la">
<div class="a_la_mian">
<div class="us_lat"><div class="a_lat_title"><span>联系我们</span><br/>contact us</div></div>
<div class="a_left1">
<div class="a_left2">
<div class="a_left_top"><a href="/MyProject/ALK/index.php/Home/ContactUs/contactus" class="c01">联系方式</a>
    <a href="/MyProject/ALK/index.php/Home/ContactUs/recruitment">人才招聘</a></div>
</div>
</div>
<div class="clear"></div>
</div>
...
<div class="a_rt">
<div class="a_rt_title"><div class="a_rt_title">人才招聘<span>/ Recruitment</span></div></div>
</div>
...
<table width="706" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td style="width:410px;background:#567e77; height:27px; color:#FFFFFF; font-weight:bold; text-align:center; border-right:#e7e3d8 5px solid;">职位名称</td>
    <td style="height:27px;background:#567e77; text-align:center; color:#FFFFFF; font-weight:bold;border-right:#e7e3d8 5px solid;">工作地点</td>
    <td style="height:27px;background:#567e77; text-align:center; color:#FFFFFF; font-weight:bold;border-right:#e7e3d8 5px solid;">招聘人数</td>
    <td style="height:27px;background:#567e77; text-align:center; color:#FFFFFF; font-weight:bold;border-right:#e7e3d8 5px solid;">发布时间</td>
  </tr>
  <tr>
    <td style="text-align:center;"><?php echo ($arr[0]['position']); ?></td>
    <td style="text-align:center;"><?php echo ($arr[0]['address']); ?></td>
    <td style="text-align:center;"><?php echo ($arr[0]['num']); ?></td>
    <td style="text-align:center;"><?php echo ($arr[0]['jobdate']); ?></td>
  </tr>
</table>
