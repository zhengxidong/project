...
<ul>
    ...
    <li><a href="<?php echo U('Home/ContactUs/contactus');?>" class="c">联系我们<br/><span>Contact Us</span></a></li>
</ul>
</div>
</div>
<!-------------------------  menu e ---------------------->
...
<div class="us_t"></div>
<div class="us_c">
<div class="us_main"><img src="/MyProject/ALK/Public/Home/images/us03.jpg"/></div>
</div>
<div class="us_d"></div>

<div class="us_tel">
<dd><?php echo ($arr[0]['title']); ?></dd>
<dd>手机号码：<?php echo ($arr[0]['phone']); ?> </dd>
<dd>电话/传真：<?php echo ($arr[0]['fax']); ?></dd>
<dd>电子邮箱 ：<?php echo ($arr[0]['email']); ?></dd>
<dd>公司地址 ：<?php echo ($arr[0]['address']); ?></dd>
</div>
