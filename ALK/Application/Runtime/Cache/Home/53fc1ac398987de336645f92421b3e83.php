...
<ul>
    ...
    <li><a href="<?php echo U('Home/Member/area');?>" class="c">商务专区<br/><span>Business Area</span></a></li>
...
<div class="a_la">
<div class="a_la_mian">
<div class="Business_lat"><div class="a_lat_title"><span>商务专区</span><br/>Business Area</div></div>
<div class="a_left1">
<div class="a_left2">
<div class="a_left_top"><a href="Business Area.html" class="c01">会员中心</a><a href="Business Area1.html">供应商专区</a> <a href="../Index/Business%20Area2.html">在线订购</a> <a href="Business Area3.html">资料下载</a></div>
</div>
</div>
<div class="clear"></div>
</div>
...
<div class="a_rt">
<div class="a_rt_title">会员中心<span>/ Member Center</span></div>
</div>
...
<div class="us_t"></div>
<div class="us_c">
<div class="Business_main1">
<div class="Business_main1_main">
<div class="Business_main1t">会员注册</div>
<div class="kf11">
<form>
<table width="346" border="1">
  <tr>
    <td width="90">用户名：</td>
    <td width="278"><input type="text" size="40" maxlength="100"  style=" height:25px;border:1px solid #ccc;" /><font color="#CC0000">*</font></td>
  </tr>
  <tr>
  ...
  <tr>
    <td>密码：</td>
    <td><input type="text" size="40" maxlength="100"  style=" height:25px;border:1px solid #ccc;" /><font color="#CC0000">*</font></td>
  </tr>
  <tr>
  <td style=" height:10px;"></td>
  </tr>
  ...
  <tr>
    <td>会员类型：</td>
    <td><select style=" width:100px; height:25px;border:1px solid #ccc;" ><option>供应商</option><option>经销商</option><option>群众</option></select></td>
  </tr>
   <tr>
  <td style=" height:10px;"></td>
  </tr>
  ...
  <tr>
    <td>所在地：</td>
    <td><select style=" width:100px; height:25px;border:1px solid #ccc;" ><option>广西省</option><option>吉林省</option><option>广东省</option></select></td>
  </tr>
   <tr>
  <td style=" height:10px;"></td>
  </tr>
  <tr>
    <td>邮箱：</td>
    <td><input type="text" size="40" maxlength="100"  style=" height:25px;border:1px solid #ccc;" /></td>
  </tr>
    <tr>
  <td style=" height:10px;"></td>
  </tr>
...
<table width="336" border="1">
  <tr>
    <td width="110"><input name="Submit" type="image" src="/MyProject/ALK/Public/Home/images/Business04.jpg" /></td>
    <td width="110">&nbsp;</td>
    <td width="110"><input name="Submit" type="image" src="/MyProject/ALK/Public/Home/images/Business05.jpg" /></td>
  </tr>
</table>
