<?php /* Smarty version Smarty-3.1.14, created on 2017-03-26 10:12:06
         compiled from ".\template\attr\index.html" */ ?>
<?php /*%%SmartyHeaderCode:1820958d793f6792ac5-86795402%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'aee98355a4659766350a7076e174b4dfe1dc694c' => 
    array (
      0 => '.\\template\\attr\\index.html',
      1 => 1489076116,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1820958d793f6792ac5-86795402',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_58d793f70939c2_38739589',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_58d793f70939c2_38739589')) {function content_58d793f70939c2_38739589($_smarty_tpl) {?><!doctype html>
<html lang="en"><head>
    <meta charset="utf-8">
    ...
    <ul>
        ...
        <li><ul class="dashboard-menu nav nav-list collapse in">
           <!-- <li ><a href="../zp/index.php"><span class="fa fa-caret-right"></span> 招聘管理</a></li>
            ...
            <li class="active"><a href="?c=attr&a=select"><span class="fa fa-caret-right"></span> 属性管理</a></li>
...
<div class="content">
    ...
    <div class="main-content">
        ...
        <div class="btn-toolbar list-toolbar">
            ...
            <a href="?c=attr&a=add" class="btn btn-primary"><i class="fa fa-plus"></i> 添加属性</a>

        </div>
        <table class="table table-hover">
            <thead>
            <div class="col-md-1 col-md-offset-10">
                <input type="button" class="btn btn-primary col-md-offset-11" id="getValue" value="删除选中项" onclick="del('<?php echo $_smarty_tpl->tpl_vars['attr']->value;?>
','<?php echo $_smarty_tpl->tpl_vars['delAll']->value;?>
')"/>
            </div>
            <tr>
...
'}" role="button" data-toggle="modal"><i class="fa fa-trash-o" onclick="del('attr','delAll');"></i></a>
                </td>
            </tr>
            <?php }?>
            <?php } ?>
