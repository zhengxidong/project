<?php /* Smarty version Smarty-3.1.14, created on 2017-03-10 03:48:18
         compiled from "template\index.html" */ ?>
<?php /*%%SmartyHeaderCode:1717258bfc37b01c6d0-83400177%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '1717258bfc37b01c6d0-83400177',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.14',
  'unifunc' => 'content_58bfc37b3158f3_06128333',
  'variables' => 
  array (
    'arr' => 0,
  ),
...
<?php if ($_valid && !is_callable('content_58bfc37b3158f3_06128333')) {function content_58bfc37b3158f3_06128333($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
 ...
 <div id="header_top">
  <div id="top">
    <div class="Inside_pages">
        ...
        <?php }else{ ?>
        <div class="Collection"><a href="#" class="green">欢迎，<?php echo $_smarty_tpl->tpl_vars['arr']->value;?>
	...
	<div class="hd_top_manu clearfix">
	  <ul class="clearfix">
	   ...
	   <li class="hd_menu_tit" data-addclass="hd_menu_hover"> <a href="usercenter.html">我的伊美人</a> </li>
  		...
  		<div class="slideGroup">
			...
			<div class="parBd">
					<div class="slideBoxs">
						...
						<ul>
							<li>
								<div class="pic"><a href="#" target="_blank"><img src="./public/products/p_11.jpg" /></a></div>
								<div class="title">
							...
							<li>
								<div class="pic"><a href="#" target="_blank"><img src="./public/products/p_12.jpg" /></a></div>
								<div class="title">
                                <a href="#" target="_blank" class="name">乐事 无限薯片三连装（原味+番茄+烤肉）104g*3/组</a>
                                <h3><b>￥</b>23.00</h3>
                                </div>
							...
							<li>
								<div class="pic"><a href="#" target="_blank"><img src="./public/products/p_13.jpg" /></a></div>
								<div class="title">
                                <a href="#" target="_blank" class="name">乐事 无限薯片三连装（原味+番茄+烤肉）104g*3/组</a>
                                <h3><b>￥</b>23.00</h3>
                                </div>
							...
							<li>
								<div class="pic"><a href="#" target="_blank"><img src="./public/products/p_15.jpg" /></a></div>
								<div class="title">
                                <a href="#" target="_blank" class="name">乐事 无限薯片三连装（原味+番茄+烤肉）104g*3/组</a>
                                <h3><b>￥</b>23.00</h3>
                                </div>
					...
					<div class="slideBoxs">
						...
						<ul>
							...
							<li>
								<div class="pic"><a href="#" target="_blank"><img src="./public/products/p_34.jpg" /></a></div>
								<div class="title">
                                <a href="#" target="_blank" class="name">乐事 无限薯片三连装（原味+番茄+烤肉）104g*3/组</a>
                                <h3><b>￥</b>23.00</h3>
                                </div>
							...
							<li>
								<div class="pic"><a href="#" target="_blank"><img src="./public/products/p_58.jpg" /></a></div>
								<div class="title">
                                <a href="#" target="_blank" class="name">乐事 无限薯片三连装（原味+番茄+烤肉）104g*3/组</a>
                                <h3><b>￥</b>23.00</h3>
                                </div>
					...
					<div class="slideBoxs">
						...
						<ul>
							<li>
								<div class="pic"><a href="#" target="_blank"><img src="./public/products/p_57.jpg" /></a></div>
								<div class="title">
                                <a href="#" target="_blank" class="name">乐事 无限薯片三连装（原味+番茄+烤肉）104g*3/组</a>
                                <h3><b>￥</b>23.00</h3>
                                </div>
							...
							<li>
								<div class="pic"><a href="#" target="_blank"><img src="./public/products/p_56.jpg" /></a></div>
								<div class="title">
                                <a href="#" target="_blank" class="name">乐事 无限薯片三连装（原味+番茄+烤肉）104g*3/组</a>
                                <h3><b>￥</b>23.00</h3>
                                </div>
							...
							<li>
								<div class="pic"><a href="#" target="_blank"><img src="./public/products/p_54.jpg" /></a></div>
								<div class="title">
                                <a href="#" target="_blank" class="name">乐事 无限薯片三连装（原味+番茄+烤肉）104g*3/组</a>
                                <h3><b>￥</b>23.00</h3>
                                </div>
							...
							<li>
								<div class="pic"><a href="#" target="_blank"><img src="./public/products/p_55.jpg" /></a></div>
								<div class="title">
                                <a href="#" target="_blank" class="name">乐事 无限薯片三连装（原味+番茄+烤肉）104g*3/组</a>
                                <h3><b>￥</b>23.00</h3>
                                </div>
