<?php /* Smarty version Smarty-3.1.14, created on 2017-03-06 08:10:49
         compiled from ".\template\Home\index.html" */ ?>
<?php /*%%SmartyHeaderCode:521858b27b11c0c2b9-62282183%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'a39143b6247b7c802e390b3b106060d33d1768f9' => 
    array (
      0 => '.\\template\\Home\\index.html',
      1 => 1488787775,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '521858b27b11c0c2b9-62282183',
  'function' => 
  array (
    'menu' => 
    array (
  ...
  'unifunc' => 'content_58b27b12116ab5_57591403',
  'variables' => 
  array (
    'arr' => 0,
    'value' => 0,
...
<?php if ($_valid && !is_callable('content_58b27b12116ab5_57591403')) {function content_58b27b12116ab5_57591403($_smarty_tpl) {?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <link id="color_scheme" href="./public/css/theme.css" rel="stylesheet">
                       ...
                       <!-- <div class="form-group languages-block ">
                            <form action="index.html" method="post" enctype="multipart/form-data" id="bt-language">
                                <a class="btn btn-xs dropdown-toggle" data-toggle="dropdown">
                                    <img src="./public/img/demo/flags/gb.png" alt="English" title="English">
                                    <span class="">English</span>
                                    <span class="fa fa-angle-down"></span>
                                </a>
                                <ul class="dropdown-menu">
                                    <li><a href="index.html"><img class="./public/img_flag" src="./public/img/demo/flags/gb.png" alt="English" title="English" /> English </a></li>
                                    <li> <a href="index.html"> <img class="./public/img_flag" src="./public/img/demo/flags/lb.png" alt="Arabic" title="Arabic" /> Arabic </a> </li>
                                </ul>
                            </form>
                        </div>-->
                        ...
                        <div class="tabBlock" id="TabBlock-1">
                            <ul class="top-link list-inline">
                                <li class="account" id="my_account">
                                    <a href="#" title="My Account" class="btn btn-xs dropdown-toggle" data-toggle="dropdown"> <span >个人中心</span> <span class="fa fa-angle-down"></span></a>
                                    <ul class="dropdown-menu ">
                                        <li><a href="register.html"><i class="fa fa-user"></i> 注册</a></li>
                                        <li><a href="login.html"><i class="fa fa-pencil-square-o"></i> 登录</a></li>
                                    </ul>
                                </li>
                                <li class="wishlist"><a href="#" id="wishlist-total" class="top-link-wishlist" title="Wish List (2)"><span>购物清单 (2)</span></a></li>
                                <li class="checkout"><a href="#" class="top-link-checkout" title="Checkout"><span >结账</span></a></li>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="navbar-logo col-md-3 col-sm-12 col-xs-12">
                        <a href="index.html"><img src="./public/img/demo/logos/theme_logo.png" title="Your Store" alt="Your Store" /></a>
                    </div>
                    <!-- //end Logo -->
                                    ...
                                    <table class="table table-striped">
                                        ...
                                        <tr>
                                            <td class="text-center" style="width:70px">
                                                <a href="product.html"> <img src="./public/img/demo/shop/product/35.jpg" style="width:70px" alt="Filet Mign" title="Filet Mign" class="preview"> </a>
                                            </td>
                                        ...
                                        <tr>
                                            <td class="text-center" style="width:70px">
                                                <a href="product.html"> <img src="./public/img/demo/shop/product/141.jpg" style="width:70px" alt="Canon EOS 5D" title="Canon EOS 5D" class="preview"> </a>
                                            </td>
                                                    ...
                                                    <ul class="megamenu">
                                                        ...
                                                        <li class="item-vertical style1 with-sub-menu hover">
                                                            ...
                                                            <a href="#" class="clearfix">
                                                                <img src="./public/img/theme/icons/9.png" alt="icon">
                                                                        ...
                                                                        <div class="col-sm-12">
                                                                            <div class="row">
                                                                                <div class="col-md-4 static-menu">
                                                                                    <div class="menu">
                                                                                        <ul>
                                                                                            <?php  $_smarty_tpl->tpl_vars['valuet'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['valuet']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['arr']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['valuet']->key => $_smarty_tpl->tpl_vars['valuet']->value){
$_smarty_tpl->tpl_vars['valuet']->_loop = true;
?>
                                                                                            <li>
                                                                                                <?php if ($_smarty_tpl->tpl_vars['valuet']->value['father']==$_smarty_tpl->tpl_vars['value']->value['id']){?>
                                                                                                <a href="#"  class="main-menu"> <?php echo $_smarty_tpl->tpl_vars['valuet']->value['name'];?>
</a>
                                                                                                <?php }?>
                                                                                                <ul>
                                                        ...
                                                        <!--<li class="item-vertical">
                                                            <p class="close-menu"></p>
                                                            <a href="#" class="clearfix">
                                                                <img src="./public/img/theme/icons/10.png" alt="icon">
                                                        ...
                                                        <li class="item-vertical with-sub-menu hover">
                                                            ...
                                                            <a href="#" class="clearfix">
                                                                ...
                                                                <img src="./public/img/theme/icons/3.png" alt="icon">
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-md-6">
                                                                            <div class="row banner">
                                                                                <a href="#">
                                                                                    <img src="./public/img/demo/cms/menu_bg2.jpg" alt="banner1">
                                                                                </a>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                        ...
                                                        <li class="item-vertical with-sub-menu hover">
                                                            <p class="close-menu"></p>
                                                            <a href="#" class="clearfix">
                                                                <img src="./public/img/theme/icons/2.png" alt="icon">
                                                        ...
                                                        <li class="item-vertical">
                                                            <p class="close-menu"></p>
                                                            <a href="#" class="clearfix">
                                                                <img src="./public/img/theme/icons/11.png" alt="icon">
                                                        ...
                                                        <li class="item-vertical">
                                                            <p class="close-menu"></p>
                                                            <a href="#" class="clearfix">
                                                                <img src="./public/img/theme/icons/4.png" alt="icon">
                                                        ...
                                                        <li class="item-vertical">
                                                            <p class="close-menu"></p>
                                                            <a href="#" class="clearfix">
                                                                <img src="./public/img/theme/icons/5.png" alt="icon">
                                                                <span>Smartphone &amp; Tablets</span>
                                                            </a>
                                                        </li>
                                                        <li class="item-vertical" >
                                                            <p class="close-menu"></p>
                                                            <a href="#" class="clearfix">
                                                                <img src="./public/img/theme/icons/7.png" alt="icon">
                                                        ...
                                                        <li class="item-vertical" style="display: none;">
                                                            ...
                                                            <a href="#" class="clearfix">
                                                                <img src="./public/img/theme/icons/6.png" alt="icon">
                                                                <span>Health &amp; Beauty</span>
                                                            </a>
                                                        </li>
                                                        <li class="item-vertical" >
                                                            <p class="close-menu"></p>
                                                            <a href="#" class="clearfix">
                                                                <img src="./public/img/theme/icons/8.png" alt="icon">
                                                        ...
                                                        <li class="item-vertical" >
                                                            <p class="close-menu"></p>
                                                            <a href="#" class="clearfix">
                                                                <img src="./public/img/theme/icons/12.png" alt="icon">
                                                        ...
                                                        <li class="item-vertical" >
                                                            <p class="close-menu"></p>
                                                            <a href="#" class="clearfix">
                                                                <img src="./public/img/theme/icons/13.png" alt="icon">
                                            ...
                                            <div class="container">
                                                <ul class="megamenu " data-transition="slide" data-animationtime="250">
                                                    <li class="home hover">
                                                        ...
                                                        <a href="index.html">秒杀 <b class="caret"></b></a>
                                                        <div class="sub-menu" style="width:100%;" >
                                                            <div class="content" >
                                                                <div class="row">
                                                                    <div class="col-md-3">
                                                                        <a href="index.html" class="./public/img-link">
													<span class="thumbnail">
														<img class="img-responsive img-border" src="./public/img/demo/feature/home-1.jpg" alt="">
														<span class="btn btn-default">Read More</span>
                                                                    ...
                                                                    <div class="col-md-3">
                                                                        <a href="#" class="./public/img-link">
													<span class="thumbnail">
														<img class="img-responsive img-border" src="./public/img/demo/feature/home-2.jpg" alt="">
														<span class="btn btn-default">Read More</span>
													</span>
                                                                    ...
                                                                    <div class="col-md-3">
                                                                        <a href="#" class="./public/img-link">
													<span class="thumbnail">
														<img class="img-responsive img-border" src="./public/img/demo/feature/home-3.jpg" alt="">
														<span class="btn btn-default">Read More</span>
													</span>
                                                                    ...
                                                                    <div class="col-md-3">
                                                                        <a href="#" class="./public/img-link">
													<span class="thumbnail">
														<img class="img-responsive img-border" src="./public/img/demo/feature/home-4.jpg" alt="">
														<span class="btn btn-default">Read More</span>
													</span>
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-3">
                                                                        <div class="column">
                                                                            ...
                                                                            <div>
                                                                                <ul class="row-list">
                                                                                    <li><a href="product.html">./public/img size - big</a></li>
                                                                                    <li><a href="#">./public/img size - medium</a></li>
                                                                                    <li><a href="#">./public/img size - small</a></li>
                                                                                </ul>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="col-sm-12">
                                                                        <div class="row">
                                                                            <div class="col-md-3 img img1">
                                                                                <a href="#"><img src="./public/img/demo/cms/img1.jpg" alt="banner1"></a>
                                                                            </div>
                                                                            <div class="col-md-3 img img2">
                                                                                <a href="#"><img src="./public/img/demo/cms/img2.jpg" alt="banner2"></a>
                                                                            </div>
                                                                            <div class="col-md-3 img img3">
                                                                                <a href="#"><img src="./public/img/demo/cms/img3.jpg" alt="banner3"></a>
                                                                            </div>
                                                                            <div class="col-md-3 img img4">
                                                                                <a href="#"><img src="./public/img/demo/cms/img4.jpg" alt="banner4"></a>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                    ...
                                                                    <div class="col-md-4">
                                                                        ...
                                                                        <div class="col-sm-12 list-product">
                                                                            <div class="product-thumb">
                                                                                <div class="./public/img pull-left">
                                                                                    <a href="#"><img src="./public/img/demo/shop/product/35.jpg" width="80" alt="Filet Mign" title="Filet Mign" class="img-responsive"></a>
                                                                                </div>
                                                                                <div class="caption">
                                                                        ...
                                                                        <div class="col-sm-12 list-product">
                                                                            <div class="product-thumb">
                                                                                <div class="./public/img pull-left">
                                                                                    <a href="#"><img src="./public/img/demo/shop/product/W1.jpg" width="80" alt="Dail Lulpa" title="Dail Lulpa" class="img-responsive"></a>
                                                                                </div>
                                                                                <div class="caption">
                                                                        ...
                                                                        <div class="col-sm-12 list-product">
                                                                            <div class="product-thumb">
                                                                                <div class="./public/img pull-left">
                                                                                    <a href="#"><img src="./public/img/demo/shop/product/141.jpg" width="80" alt="Canon EOS 5D" title="Canon EOS 5D" class="img-responsive"></a>
                                                                                </div>
                                                                                <div class="caption">
                    ...
                    <div class="slider-container ">
                        ...
                        <div id="so-slideshow" class="col-lg-8 col-md-8 col-sm-12 col-xs-12 two-block">
                            <div class="module slideshow no-margin">
                                <div class="item">
                                    <a href="#"><img src="./public/img/demo/slider/slider-1.png" alt="slider1" class="img-responsive"></a>
                                </div>
                                <div class="item">
                                    <a href="#"><img src="./public/img/demo/slider/slider-2.png" alt="slider2" class="img-responsive"></a>
                                </div>
                                <div class="item">
                                    <a href="#"><img src="./public/img/demo/slider/slider-3.png" alt="slider3" class="img-responsive"></a>
                                </div>
                            </div>
                                ...
                                <div class="htmlcontent-block">
                                    <ul class="htmlcontent-home">
                                        <li>
                                            <div class="banners">
                                                <div>
                                                    <a href="#"><img src="./public/img/demo/cms/banner1.jpg" alt="banner1"></a>
                                                </div>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="banners">
                                                <div>
                                                    <a href="#"><img src="./public/img/demo/cms/banner2.jpg" alt="banner1"></a>
                                                </div>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="banners">
                                                <div>
                                                    <a href="#"><img src="./public/img/demo/cms/banner3.jpg" alt="banner1"></a>
                                                </div>
                                            </div>
                                        </li>
                                    </ul>
                                    ...
                                    <div class="ltabs-items-inner ltabs-slider ">
                                        <div class="ltabs-item product-layout">
                                            <div class="product-item-container">
                                                <div class="left-block">
                                                    <div class="product-./public/img-container second_img ">
                                                        <img src="./public/img/demo/shop/product/J9.jpg"  alt="Apple Cinema 30&quot;" class="img-responsive" />
                                                        <img src="./public/img/demo/shop/product/J5.jpg"  alt="Apple Cinema 30&quot;" class="img_0 img-responsive" />
                                                    </div>
                                                    <!--Sale Label-->
                                        ...
                                        <div class="ltabs-item product-layout">
                                            <div class="product-item-container">
                                                <div class="left-block">
                                                    <div class="product-./public/img-container second_img ">
                                                        <img src="./public/img/demo/shop/product/m1.jpg"  alt="Apple Cinema 30&quot;" class="img-responsive" />
                                                        <img src="./public/img/demo/shop/product/m3.jpg"  alt="Apple Cinema 30&quot;" class="img_0 img-responsive" />
                                                    </div>
                                                    <!--New Label-->
                                        ...
                                        <div class="ltabs-item product-layout">
                                            <div class="product-item-container">
                                                <div class="left-block">
                                                    <div class="product-./public/img-container second_img ">
                                                        <img src="./public/img/demo/shop/product/B10.jpg"  alt="Apple Cinema 30&quot;" class="img-responsive" />
                                                        <img src="./public/img/demo/shop/product/B9.jpg"  alt="Apple Cinema 30&quot;" class="img_0 img-responsive" />
                                                    </div>
                                                    <!--Sale Label-->
                                                    <span class="label label-sale">Sale</span>
                                                    <!--full quick view block-->
                                        ...
                                        <div class="ltabs-item product-layout">
                                            <div class="product-item-container">
                                                <div class="left-block">
                                                    <div class="product-./public/img-container second_img ">
                                                        <img src="./public/img/demo/shop/product/w1.jpg"  alt="Apple Cinema 30&quot;" class="img-responsive" />
                                                        <img src="./public/img/demo/shop/product/w10.jpg"  alt="Apple Cinema 30&quot;" class="img_0 img-responsive" />
                                                    </div>
                                        ...
                                        <div class="ltabs-item product-layout">
                                            <div class="product-item-container">
                                                <div class="left-block">
                                                    <div class="product-./public/img-container second_img ">
                                                        <img src="./public/img/demo/shop/product/B5.jpg"  alt="Apple Cinema 30&quot;" class="img-responsive" />
                                                        <img src="./public/img/demo/shop/product/B10.jpg"  alt="Apple Cinema 30&quot;" class="img_0 img-responsive" />
                                                    </div>
                                    ...
                                    <div class="ltabs-items-inner ltabs-slider ">
                                        <div class="ltabs-item product-layout">
                                            <div class="product-item-container">
                                                <div class="left-block">
                                                    <div class="product-./public/img-container second_img ">
                                                        <img src="./public/img/demo/shop/product/e11.jpg"  alt="Apple Cinema 30&quot;" class="img-responsive" />
                                                        <img src="./public/img/demo/shop/product/E3.jpg"  alt="Apple Cinema 30&quot;" class="img_0 img-responsive" />
                                                    </div>
                                                    <!--Sale Label-->
                                                    <span class="label label-sale">Sale</span>
                                                    <!--full quick view block-->
                                        ...
                                        <div class="ltabs-item product-layout">
                                            <div class="product-item-container">
                                                <div class="left-block">
                                                    <div class="product-./public/img-container second_img ">
                                                        <img src="./public/img/demo/shop/product/141.jpg"  alt="Apple Cinema 30&quot;" class="img-responsive" />
                                                        <img src="./public/img/demo/shop/product/11.jpg"  alt="Apple Cinema 30&quot;" class="img_0 img-responsive" />
                                                    </div>
                                        ...
                                        <div class="ltabs-item product-layout">
                                            <div class="product-item-container">
                                                <div class="left-block">
                                                    <div class="product-./public/img-container second_img ">
                                                        <img src="./public/img/demo/shop/product/35.jpg"  alt="Apple Cinema 30&quot;" class="img-responsive" />
                                                        <img src="./public/img/demo/shop/product/34.jpg"  alt="Apple Cinema 30&quot;" class="img_0 img-responsive" />
                                                    </div>
                                                    <!--Sale Label-->
                                                    <span class="label label-sale">Sale</span>
                                                    <!--full quick view block-->
                                        ...
                                        <div class="ltabs-item product-layout">
                                            <div class="product-item-container">
                                                <div class="left-block">
                                                    <div class="product-./public/img-container second_img ">
                                                        <img src="./public/img/demo/shop/product/E3_1.jpg"  alt="Apple Cinema 30&quot;" class="img-responsive" />
                                                        <img src="./public/img/demo/shop/product/E3_3.jpg"  alt="Apple Cinema 30&quot;" class="img_0 img-responsive" />
                                                    </div>
                                                    <!--Sale Label-->
                                                    <span class="label label-sale">Sale</span>
                                                    <!--full quick view block-->
                        ...
                        <div class="banner-wraps ">
                            <div class="m-banner row">
                                <div class="banner htmlconten1 col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                    <div class="banners">
                                        <div>
                                            <a href="#"><img src="./public/img/demo/cms/banner2-1.png" alt="banner1"></a>
                                        </div>
                                    </div>
                                </div>
                                <div class="htmlconten2 col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                    <div class="module banners">
                                        <div>
                                            <a href="#"><img src="./public/img/demo/cms/banner2-2.png" alt="banner1"></a>
                                        </div>
                                    </div>

                                    <div class="banners">
                                        <div>
                                            <a href="#"><img src="./public/img/demo/cms/banner2-3.png" alt="banner1"></a>
                                        </div>
                                    </div>
                                ...
                                <div class="banner htmlconten3 hidden-sm col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                    <div class="banners">
                                        <div>
                                            <a href="#"><img src="./public/img/demo/cms/banner2-4.png" alt="banner1"></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="wrap-categories">
                        <div class="cat-wrap theme3">
                            <div class="content-box">
                                <div class="./public/img-cat">
                                    <a href="#" title="Automotive" target="_blank">
                                        <img  src="./public/img/demo/shop/category/automotive-motocrycle.jpg" title="Automotive" alt="Automotive">
                                    </a>
                            ...
                            <div class="content-box">
                                <div class="./public/img-cat">
                                    <a href="#" title="Automotive" target="_blank">
                                        <img  src="./public/img/demo/shop/category/health-beauty.jpg" title="Automotive" alt="Automotive">
                                    </a>
                                    <a class="btn-viewmore hidden-xs" href="#" title="View more">View more</a>
                                </div>
                            ...
                            <div class="content-box">
                                <div class="./public/img-cat">
                                    <a href="#" title="Automotive" target="_blank">
                                        <img  src="./public/img/demo/shop/category/bags-holiday-supplies-gifts.jpg" title="Automotive" alt="Automotive">
                                    </a>
                                    <a class="btn-viewmore hidden-xs" href="#" title="View more">View more</a>
                                </div>
                            ...
                            <div class="content-box">
                                <div class="./public/img-cat">
                                    <a href="#" title="Automotive" target="_blank">
                                        <img  src="./public/img/demo/shop/category/toys-hobbies.jpg" title="Automotive" alt="Automotive">
                                    </a>
                                    <a class="btn-viewmore hidden-xs" href="#" title="View more">View more</a>
                                </div>
                            ...
                            <div class="content-box">
                                <div class="./public/img-cat">
                                    <a href="#" title="Automotive" target="_blank">
                                        <img  src="./public/img/demo/shop/category/electronics.jpg" title="Automotive" alt="Automotive">
                                    </a>
                                    <a class="btn-viewmore hidden-xs" href="#" title="View more">View more</a>
                                </div>
                            ...
                            <div class="content-box">
                                <div class="./public/img-cat">
                                    <a href="#" title="Automotive" target="_blank">
                                        <img  src="./public/img/demo/shop/category/jewelry-watches.jpg" title="Automotive" alt="Automotive">
                                    </a>
                                    <a class="btn-viewmore hidden-xs" href="#" title="View more">View more</a>
                                </div>
                            ...
                            <div class="content-box">
                                <div class="./public/img-cat">
                                    <a href="#" title="Automotive" target="_blank">
                                        <img  src="./public/img/demo/shop/category/sports-outdoors.jpg" title="Automotive" alt="Automotive">
                                    </a>
                                    <a class="btn-viewmore hidden-xs" href="#" title="View more">View more</a>
                                </div>
                            ...
                            <div class="content-box">
                                <div class="./public/img-cat">
                                    <a href="#" title="Automotive" target="_blank">
                                        <img  src="./public/img/demo/shop/category/smartphone-tablets.jpg" title="Automotive" alt="Automotive">
                                    </a>
                                    <a class="btn-viewmore hidden-xs" href="#" title="View more">View more</a>
                                </div>
        ...
        <div class="footer-bottom-block ">
            <div class=" container">
                <div class="row">
                    ...
                    <div class="col-sm-7">
                        <div class="block-payment text-right"><img src="./public/img/demo/content/payment.png" alt="payment" title="payment" ></div>
                    </div>
                    <!--Back To Top-->
...
<section class="social-widgets visible-lg">
    <ul class="items">
        <li class="item item-01 facebook"> <a href="" class="tab-icon"><span class="fa fa-facebook"></span></a>
            <div class="tab-content">
                <div class="title">
                    <h5>FACEBOOK</h5>
                </div>
                <div class="loading">
                    <img src="./public/img/theme/lazy-loader.gif" class="ajaxloader" alt="loader">
                </div>
            </div>
        </li>
        <li class="item item-02 twitter"> <a href="" class="tab-icon"><span class="fa fa-twitter"></span></a>
            <div class="tab-content">
                <div class="title">
                    <h5>TWITTER FEEDS</h5>
                </div>
        ...
        <li class="item item-03 youtube"> <a href="#" class="tab-icon"><span class="fa fa-youtube"></span></a>
            <div class="tab-content">
                ...
                <div class="loading"> <img src="./public/img/theme/lazy-loader.gif" class="ajaxloader" alt="loader"></div>
            </div>
        </li>
    </ul>
</section>	<!-- End Social widgets -->

<link rel='stylesheet' property='stylesheet'  href='./public/css/themecss/cpanel.css' type='text/css' media='all' />
...
<script type="text/javascript" src="./public/js/themejs/toppanel.js"></script>
...
<script type="text/javascript" src="./public/js/themejs/cpanel.js"></script>
</body>
</html>
