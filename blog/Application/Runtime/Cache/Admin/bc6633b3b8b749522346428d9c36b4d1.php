  ...
  <div class="row">
    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-lg-10 col-md-offset-2 main" id="main">
      <form action="/Article/checkAll" method="post" >
        ...
        <ol class="breadcrumb">
          <li><a href="/Admin/Article/add"><i class="fa fa-plus-square-o"></i>发布文章</a></li>
        </ol>
          ...
          <table class="table table-striped table-hover">
            ...
            <?php if(is_array($article)): foreach($article as $key=>$value): ?><tr>
                <td><input type="checkbox" class="input-control" name="checkbox[]" value="" /></td>
                  <td class="article-title"><img src="/Public/Upload/zoom/<?php echo ($value['titlepic']); ?>" alt=""/></td>
                <td class="article-title"><?php echo ($value['articletitle']); ?></td>
                  <?php if(($value['ispublic'] == 0)): ?><td class="hidden-sm">是</td>
                      <?php else: ?>
                      <td class="hidden-sm">否</td><?php endif; ?>
                <td><?php echo ($value['articletime']); ?></td>
                <td>
                    <a href="/Admin/Article/detail/id/<?php echo ($value['id']); ?>">查看</a>
                    <a href="/Admin/Article/edit/id/<?php echo ($value['id']); ?>"><i class="fa fa-edit"></i></a>
                    <a rel="6" href="/Admin/Article/delete/id/<?php echo ($value['id']); ?>"><i class="fa fa-trash-o"></i></a>
                </td>
