  ...
  <div class="row">
    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-lg-10 col-md-offset-2 main" id="main">
      <form action="/Comment/checkAll" method="post">
          <ol class="breadcrumb">
              <li><a href="/Admin/ResourcesType/add"><i class="fa fa-plus-square-o"></i>添加资源分类</a></li>
          </ol>
          ...
          <table class="table table-striped table-hover">
            <thead>
              <tr>
                ...
                <th><span class="glyphicon glyphicon-file"></span> <span class="visible-lg">分类名</span></th>
            ...
            <?php if(is_array($list)): foreach($list as $key=>$value): ?><tr>
                ...
                <td class="article-title"><?php echo ($value['resourcestypename']); ?></td>
                <td>
                    <a href="/Admin/ResourcesType/edit/id/<?php echo ($value['id']); ?>"><i class="fa fa-edit"></i></a>
                    <a rel="1" name="delete" onclick="del(<?php echo ($value['id']); ?>)"><i class="fa fa-trash-o"></i></a></td>
              </tr><?php endforeach; endif; ?>
            <script>
                function del(id){
                    if(confirm('确认删除吗')){
                        location.href='/Admin/ResourcesType/delete/id/'+id;
                    }
                    return false;
                }
            </script>
    ...
    $("#main table tbody tr td a").click(function () {
        ...
        if (name.attr("name") === "see") {
            ...
            if (window.confirm("此操作不可逆，是否确认？")) {
                $.ajax({
                    type: "POST",
                    url: "/Admin/ResourcesType/delete/id/",
                    data: "id=" + id,
                    cache: false, //不缓存此页面   
                    success: function (data) {
