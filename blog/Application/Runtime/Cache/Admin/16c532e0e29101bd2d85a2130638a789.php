...
<section class="container-fluid">
  ...
  <div class="row">
    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-lg-10 col-md-offset-2 main" id="main">
      <div class="row">
        <form action="/Admin/ResourcesType/update" method="post" autocomplete="off" draggable="false">
          ...
          <div class="col-md-9">
            ...
            <div class="add-article-box">
              ...
              <div class="add-article-box-content">
                <input type="text" name="resourcestypename" value="<?php echo ($arr['resourcestypename']); ?>" class="form-control" placeholder="请输入站点副标题" autocomplete="off">
                <span class="prompt-text">用简洁的文字描述分类名称。</span> </div>
            </div>
          </div>
          <div class="col-md-3">
