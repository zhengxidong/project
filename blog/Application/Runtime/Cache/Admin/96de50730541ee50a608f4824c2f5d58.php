...
<section class="container-fluid">
  ...
  <div class="row">
    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-lg-10 col-md-offset-2 main" id="main">
      <div class="row">
        <form action="/Admin/Friendlylink/add" method="post" autocomplete="off" draggable="false">
          <div class="col-md-9">
            ...
            <div class="add-article-box">
              ...
              <div class="add-article-box-content">
                <input type="text" name="link_name" class="form-control" autocomplete="off">
                <span class="prompt-text">用简洁的文字描述博友名称。</span> </div>
            </div>
            <div class="add-article-box">
              <h2 class="add-article-box-title"><span>友链（URL）</span></h2>
              <div class="add-article-box-content">
                <input type="text" name="link_url" class="form-control" value="http://" required autocomplete="off">
              </div>
            </div>
          </div>
          <div class="col-md-3">
