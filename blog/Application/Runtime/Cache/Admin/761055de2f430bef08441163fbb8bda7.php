...
<section class="container-fluid">
  ...
  <div class="row">
    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-lg-10 col-md-offset-2 main" id="main">
      <div class="row">
        <form action="/Admin/Article/update" method="post" class="add-article-form" enctype="multipart/form-data">
            <input type="hidden" name="id" value="<?php echo ($list['id']); ?>"/>
            <input type="hidden" name="views" value="<?php echo ($list['views']); ?>"/>
          <div class="col-md-9">
            <h1 class="page-header">编辑文章</h1>
            <div class="form-group">
              <label for="article-title" class="sr-only">标题</label>
              <input type="text" id="article-title" name="articletitle" value="<?php echo ($list['articletitle']); ?>" class="form-control" placeholder="在此处输入标题" required autofocus autocomplete="off">
            </div>
            <div class="add-article-box">
                <h2 class="add-article-box-title"><span>图片</span></h2>
                <div class="add-article-box-content">
                    <input type="file" name="titlepic" class="form-control" autocomplete="off">
                    <img src="/Public/Upload/zoom/<?php echo ($list['titlepic']); ?>" alt=""/>
                </div>
            </div>
            <div class="form-group">
              <label for="article-content" class="sr-only">内容</label>
              <script id="article-content" name="articlecontent" type="text/plain"><?php echo (htmlspecialchars_decode($list['articlecontent'])); ?></script>
            </div>
            <!--<div class="add-article-box">
            ...
            <div class="add-article-box">
              ...
              <div class="add-article-box-content">
              	<textarea class="form-control" name="description" autocomplete="off"><?php echo ($list['id']); ?></textarea>
          ...
          <div class="col-md-3">
            ...
            <div class="add-article-box">
              ...
              <div class="add-article-box-content">
                  <?php echo wz($taglist,$tagarr);?>
                  <!--<?php if(is_array($tagarr)): foreach($tagarr as $key=>$value): if($list['id'] == $value['articleid']): ?><input style="margin: 0;" type="checkbox" class="form-control" name="name[]" value="&lt;!&ndash;{$value['id']}&ndash;&gt;" checked><span>&lt;!&ndash;{$value['name']}&ndash;&gt;</span>
                          <?php else: ?>
                          <input style="margin: 0;" type="checkbox" class="form-control" name="name[]" value="&lt;!&ndash;{$value['id']}&ndash;&gt;"><span>&lt;!&ndash;{$value['name']}&ndash;&gt;</span><?php endif; endforeach; endif; ?>-->
              </div>
            </div>
            <div class="add-article-box">
              <h2 class="add-article-box-title"><span>发布</span></h2>
              <div class="add-article-box-content">
                  <?php if($list['ispublic'] == 0): ?><p><label>公开度：</label><input type="radio" name="ispublic" value="0" checked/>公开
                    <input type="radio" name="ispublic" value="1" />加密</p>
                    <?php else: ?>
                      <p><label>公开度：</label><input type="radio" name="ispublic" value="0" />公开
                          <input type="radio" name="ispublic" value="1" checked/>加密</p><?php endif; ?>
