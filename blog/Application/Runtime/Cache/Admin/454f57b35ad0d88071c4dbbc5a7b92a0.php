...
<section class="container-fluid">
  ...
  <div class="row">
    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-lg-10 col-md-offset-2 main" id="main">
      <div class="row">
        <form action="/Admin/Resources/add" method="post" autocomplete="off" draggable="false">
          <div class="col-md-9">
            <h1 class="page-header">增加资源</h1>
            <div class="add-article-box">
                <h2 class="add-article-box-title"><span>所属资源分类</span></h2>
                <div class="add-article-box-content">
                    <select name="resourcestypeid" class="form-control selectpicker">
                        <?php if(is_array($type)): foreach($type as $key=>$value): ?><option value="<?php echo ($value['id']); ?>"><?php echo ($value['resourcestypename']); ?></option><?php endforeach; endif; ?>
                    </select>
                </div>
            </div>
            <div class="add-article-box">
              ...
              <div class="add-article-box-content">
                ...
                <span class="prompt-text">用简洁的文字描述名称。</span> </div>
            </div>
            <div class="add-article-box">
            ...
            <div class="add-article-box">
                ...
                <div class="add-article-box-content">
                    <input type="text" name="resourcespw" class="form-control" autocomplete="off">
                    <span class="prompt-text">分享密码。</span> </div>
            </div>
          </div>
          <div class="col-md-3">
