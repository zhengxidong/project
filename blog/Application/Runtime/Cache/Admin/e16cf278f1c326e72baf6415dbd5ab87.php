...
<section class="container-fluid">
  ...
  <div class="row">
    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-lg-10 col-md-offset-2 main" id="main">
      <div class="row">
        <form action="/Admin/Article/add" method="post" class="add-article-form" enctype="multipart/form-data">
          <div class="col-md-9">
            ...
            <div class="add-article-box">
                <h2 class="add-article-box-title"><span>封面图片(选择或者上传新的封面)</span></h2>
                <div class="add-article-box-content">
                    <?php if(is_array($img)): foreach($img as $key=>$value): ?><input type="radio" name="picpath" value="<?php echo ($value['picpath']); ?>" class="form-control" autocomplete="off">
                        <span class="prompt-text"><?php echo ($value['name']); ?></span><?php endforeach; endif; ?>
                </div>
                <div class="add-article-box-content">
                    <input type="file" name="titlepic" class="form-control" autocomplete="off">
                    <span class="prompt-text">上传图片。</span>
                </div>
            </div>
            <div class="form-group">
              <label for="article-content" class="sr-only">内容</label>
              <script id="article-content" name="articlecontent" type="text/plain"></script>
            </div>
            <!--<div class="add-article-box">
          ...
          <div class="col-md-3">
            ...
            <div class="add-article-box">
              <h2 class="add-article-box-title"><span>标签</span></h2>
              <div class="add-article-box-content">
                  <?php if(is_array($tag)): foreach($tag as $key=>$value): ?><input style="margin: 0;" type="checkbox" class="form-control" name="name[]" value="<?php echo ($value['id']); ?>"><span><?php echo ($value['name']); ?></span><?php endforeach; endif; ?>
              </div>
            </div>
            <div class="add-article-box">
