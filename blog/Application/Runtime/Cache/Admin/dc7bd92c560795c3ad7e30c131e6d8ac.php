...
<section class="container-fluid">
  ...
  <div class="row">
    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-lg-10 col-md-offset-2 main" id="main">
      <form action="/Admin/Tag/delAll" method="post">
          <ol class="breadcrumb">
              <li><a href="/Admin/Tag/add"><i class="fa fa-plus-square-o"></i>添加标签</a></li>
          </ol>
          ...
          <table class="table table-striped table-hover">
            <thead>
              <tr>
                ...
                <th><span class="glyphicon glyphicon-file"></span> <span class="visible-lg">标签</span></th>
                <th><span class="glyphicon glyphicon-pencil"></span> <span class="visible-lg">操作</span></th>
              </tr>
            </thead>
            <tbody>
            <?php if(is_array($list)): foreach($list as $key=>$value): ?><tr>
                <td><input type="checkbox" class="input-control" name="checkbox[]" value="<?php echo ($value['id']); ?>" /><?php echo ($value['id']); ?></td>

                  <td class="article-title"><?php echo ($value['name']); ?></td>
                <td>
                    <a href="/Admin/Tag/edit/id/<?php echo ($value['id']); ?>" name="see"><i class="fa fa-edit"></i></a>
                    <a rel="1" name="delete" onclick="del(<?php echo ($value['id']); ?>)"><i class="fa fa-trash-o"></i></a></td>
              </tr><?php endforeach; endif; ?>
            <script>
                function del(id){
                    if(confirm('确认删除吗')){
                        location.href='/Admin/Tag/delete/id/'+id;
                    }
                    return false;
                }
            </script>
          ...
          <nav>
            <div class="btn-toolbar operation" role="toolbar">
              ...
              <div class="btn-group" role="group">
                <button type="submit" onclick="if(confirm('确认删除吗？此操作不可恢复')){return true}return false" class="btn btn-default" data-toggle="tooltip" data-placement="bottom" title="删除全部选中" name="checkbox_delete">删除</button>
              </div>
            </div>
