  ...
  <div class="row">
    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-lg-10 col-md-offset-2 main" id="main">
      <form action="/Comment/checkAll" method="post">
          <ol class="breadcrumb">
              <li><a href="/Admin/Process/add">发表更新内容</a></li>
          </ol>
        ...
        <div class="table-responsive">
          <table class="table table-striped table-hover">
            ...
            <?php if(is_array($list)): foreach($list as $key=>$value): ?><tr>
                ...
                <td><?php echo ($value['updatecontent']); ?></td>
                <td><?php echo ($value['updatedate']); ?></td>
                <td>
                    <a href="/Admin/Process/edit/id/<?php echo ($value['id']); ?>" name="see"><i class="fa fa-edit"></i></a>
                    <a rel="1" name="delete" onclick="del(<?php echo ($value['id']); ?>)"><i class="fa fa-trash-o"></i></a></td>
              </tr><?php endforeach; endif; ?>
            <script>
                function del(id){
                    if(confirm('确认删除吗')){
                        location.href='/Admin/Process/delete/id/'+id;
                    }
                    return false;
                }
            </script>
