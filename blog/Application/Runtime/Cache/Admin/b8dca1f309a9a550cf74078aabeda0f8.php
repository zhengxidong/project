...
<section class="container-fluid">
  ...
  <div class="row">
    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-lg-10 col-md-offset-2 main" id="main">
      <div class="row">
        <form action="/Admin/ResourcesType/add" method="post" autocomplete="off" draggable="false">
          <div class="col-md-9">
            <h1 class="page-header">增加资源分类</h1>

            <div class="add-article-box">
              <h2 class="add-article-box-title"><span>名字</span></h2>
              <div class="add-article-box-content">
                <input type="text" name="resourcestypename" class="form-control" autocomplete="off">
                <span class="prompt-text">用简洁的文字描述分类。</span> </div>
            </div>
          </div>
          <div class="col-md-3">
