...
<section class="container-fluid">
  ...
  <div class="row">
    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-lg-10 col-md-offset-2 main" id="main">
      <div class="row">
        <form action="/Admin/Mood/add" method="post" autocomplete="off" draggable="false">
          <div class="col-md-9">
            <h1 class="page-header">发表说说</h1>

            <div class="add-article-box">
              <h2 class="add-article-box-title"><span>内容</span></h2>
              <div class="add-article-box-content">
                <textarea type="text" name="mood_content" class="form-control" autocomplete="off"></textarea>
                <span class="prompt-text">用简洁的文字描述心情。</span> </div>
            </div>
          </div>
          <div class="col-md-3">
            ...
            <div class="add-article-box">
              ...
              <div class="add-article-box-footer">
                <button class="btn btn-primary" type="submit" name="submit">发表</button>
              </div>
            </div>
          </div>
        </form>
