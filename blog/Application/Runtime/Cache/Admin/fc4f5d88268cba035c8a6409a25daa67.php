  ...
  <div class="row">
    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-lg-10 col-md-offset-2 main" id="main">
      <form action="/Comment/checkAll" method="post">
          <ol class="breadcrumb">
              <li><a href="/Admin/Message/add">发表说说</a></li>
          </ol>
          ...
          <table class="table table-striped table-hover">
            <thead>
              <tr>
                ...
                <th><span class="glyphicon glyphicon-time"></span> <span class="visible-lg">留言时间</span></th>
                <th><span class="glyphicon glyphicon-file"></span> <span class="visible-lg">等级</span></th>
            ...
            <?php if(is_array($list)): foreach($list as $key=>$value): ?><tr>
                ...
                <td><?php echo ($value['message_user_ip']); ?></td>
                <td><?php echo ($value['message_time']); ?></td>
                <td><?php echo ($value['message_level']); ?></td>
                <td>
                    <a href="/Admin/Message/edit/id/<?php echo ($value['mood_id']); ?>" name="see"><i class="fa fa-edit"></i></a>
