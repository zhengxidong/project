  ...
  <div class="row">
    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-lg-10 col-md-offset-2 main" id="main">
      <form action="/Comment/checkAll" method="post">
          <ol class="breadcrumb">
              <li><a href="/Admin/Friendlylink/add"><i class="fa fa-plus-square-o"></i>增加友链</a></li>
          </ol>
          ...
          <table class="table table-striped table-hover">
            <thead>
              <tr>
                ...
                <th><span class="glyphicon glyphicon-file"></span> <span class="visible-lg">友链</span></th>
                <th><span class="glyphicon glyphicon-file"></span> <span class="visible-lg">友链名</span></th>
                <th><span class="glyphicon glyphicon-time"></span> <span class="visible-lg">添加友链时间</span></th>
            ...
            <?php if(is_array($list)): foreach($list as $key=>$value): ?><tr>
                ...
                <td class="article-title"><?php echo ($value['link_url']); ?></td>
                <td><?php echo ($value['link_name']); ?></td>
                <td><?php echo (sj($value['link_date'])); ?></td>
                <td>
                    <a href="/Admin/Friendlylink/edit/id/<?php echo ($value['link_id']); ?>" name="see"><i class="fa fa-edit"></i></a>
                    <a rel="1" name="delete" onclick="del(<?php echo ($value['link_id']); ?>)"><i class="fa fa-trash-o"></i></a></td>
              </tr><?php endforeach; endif; ?>
            <script>
                function del(id){
                    if(confirm('确认删除吗')){
                        location.href='/Admin/Friendlylink/delete/id/'+id;
                    }
                    return false;
                }
            </script>
    ...
    $("#main table tbody tr td a").click(function () {
        ...
        if (name.attr("name") === "see") {
            ...
            if (window.confirm("此操作不可逆，是否确认？")) {
                $.ajax({
                    type: "POST",
                    url: "/Admin/Friendlylink/delete/id/",
                    data: "id=" + id,
                    cache: false, //不缓存此页面   
                    success: function (data) {
