...
<link href="/Public/Home/css/share.css" rel="stylesheet">
...
<article class="blogs">
<h1 class="t_nav"><span>好咖啡要和朋友一起品尝，好“模板”也要和同样喜欢它的人一起分享。 </span><a href="/" class="n2">模板分享</a></h1>
<div class="newblog left">
   <div class="blog_left">
       <h2>仿新浪博客风格・梅――古典个人博客模板</h2>
       <p class="dateview"><span>发布时间：2013-11-04</span><span>作者：郑锡东</span><span>模板分类：[<a href="/news/life/">个人博客模板</a>]</span></p>
...
<aside class="right">
   <div class="rnav">
      ...
      <ul>
       ...
       <li><a href="/Home/Share/resourcesshare" target="_blank">资源分享</a></li>
     </ul>      
    </div>
<div class="news">
      <div class="news_right">
          ...
          <ul class="rank">
              <?php if(is_array($article)): foreach($article as $key=>$value): ?><li><i class="fa fa-bookmark-o"></i><a href="/Home/Share/newdetail/id/<?php echo ($value['id']); ?>" title="<?php echo ($value['articletitle']); ?>" target="_blank"><?php echo ($value['articletitle']); ?></a></li><?php endforeach; endif; ?>
          </ul>
        </div>
        <div class="news_right news_right_ph">
            <h3 class="ph">
              <p><span>点击排行</span></p>
            </h3>
            <ul class="paih">
                <?php if(is_array($articleph)): foreach($articleph as $key=>$value): ?><li><i class="fa fa-bookmark-o"></i><a href="/Home/Share/newdetail/<?php echo ($value['id']); ?>" title="<?php echo ($value['articletitle']); ?>" target="_blank"><?php echo ($value['articletitle']); ?></a></li><?php endforeach; endif; ?>
            </ul>
        </div>
    </div>
