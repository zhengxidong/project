<?php /* Smarty version Smarty-3.1.14, created on 2017-03-16 14:20:31
         compiled from "template\register.html" */ ?>
<?php /*%%SmartyHeaderCode:1569358c5476dd547e2-11901328%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '1569358c5476dd547e2-11901328',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.14',
  'unifunc' => 'content_58c5476ddd8434_35807946',
  'has_nocache_code' => false,
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_58c5476ddd8434_35807946')) {function content_58c5476ddd8434_35807946($_smarty_tpl) {?><!DOCTYPE html>
<html>
	<head>
		<meta charset="UTF-8">
		<title>伊美人网站注册</title>
			...
			<div class="logo_box ClearFix">
				...
				<div class="login_b_r ClearFix">
					<div class="loginul ClearFix">
					  ...
					  <div class="co"> 
                        <div class="form">
                        <form id="register_form" method="post" action="?c=index&a=add">
                            <div class="item">
                            ...
                            <div class="item items">
                                <input placeholder="邮箱" class="itxt"  name="email" id="email" type="text">
                           ...
                           <!-- <div class="item item3">
                            ...
                            <div class="item item5">
                                <div class="login-btn">
                                    <input id="loginsubmit" tabindex="7" class="btn-img btn-entry" type="submit" value="立即注册"></input>
                                </div>
                                <div class="agree">
                                   <!-- <input class="jdcheckbox" tabindex="8" name="agree" id="agree" checked="checked" type="checkbox">-->
                                    <label for="autoLogin">我已阅读并接受伊美人<span><a href="?c=index&a=protocol" target="_blank">《用户服务协议》</a></span>条款。</label>
                                </div>
                            </div>
                        </form>
                        </div>
        ...
        $(function(){
            $("#name").blur(function(){
                ...
                if(!user.test($(this).val())){
                    $("#error_username").show().css("color","#fca1a5");
                    /*$("#name").css({"border":"1px solid #fca1a5","background-color":"#ffe6e7"});*/
                    $("#name").removeClass("itxt");
                    $("#name").addClass("textinout");
                }
                else{
                    $("#error_dui").show();
                    $("#username").hide();
                ...
                $("#error_username").hide().css("color","#fff");
                $("#name").removeClass("textinout");
                $("#name").addClass("itxt");
            });
            $("#email").blur(function(){
