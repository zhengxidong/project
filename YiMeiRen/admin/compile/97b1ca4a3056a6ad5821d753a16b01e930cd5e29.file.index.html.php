<?php /* Smarty version Smarty-3.1.14, created on 2017-03-08 07:39:36
         compiled from "template\Home\index.html" */ ?>
<?php /*%%SmartyHeaderCode:2421658bfb0426ed953-68045249%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '2421658bfb0426ed953-68045249',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.14',
  'unifunc' => 'content_58bfb042aebaf3_91547472',
  'has_nocache_code' => false,
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_58bfb042aebaf3_91547472')) {function content_58bfb042aebaf3_91547472($_smarty_tpl) {?>﻿<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
<html lang="en">
	<head>
		<meta charset="utf-8" />
		...
		<!-- <![endif]-->
		<!--[if IE]>
         <script type="text/javascript">window.jQuery || document.write("<script src='../public/admin/assets/js/jquery-1.10.2.min.js'>"+"<"+"script>");</script>
        <![endif]-->
...
<script type="text/javascript">
                  ...
                  <li>
                    ...
                    <ul class="submenu">
                    <li class="home"><a href="javascript:void(0)" name="?c=user&a=userlist" title="会员列表"  class="iframeurl"><i class="icon-double-angle-right"></i>会员列表</a></li>
...
<!-- /.page-content -->
		 ...
		 <script type="text/javascript">try{ace.settings.check('footerstyle' , 'fixed')}catch(e){}</script>
          <p class="l_f">版权所有：伊美人软件  苏ICP备11011739号</p>
          <p class="r_f">地址：广东省市深圳南山区阅江楼街道公共路64号  邮编：210011 技术支持：XXXX</p>
         </div>
         <!--修改密码样式-->
