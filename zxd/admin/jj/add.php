...
<div class="row">
  <div class="col-md-4">
    ...
    <div id="myTabContent" class="tab-content">
      ...
      <form action="upload.php" method="post" id="tab" enctype="multipart/form-data">
        ...
        <div class="form-group">
          <label>内容</label>
          <textarea value="Smith" rows="12" name="synopsiscontent" class="form-control"></textarea>
        </div>
        <div class="form-group">
            <label>分类</label>
        ...
        <!-- <div class="form-group">
         <label>发布时间</label
          <input type="hidden" name="releasedate" class="form-control">
        </div> -->
