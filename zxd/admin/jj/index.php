  ...
  <!--<![endif]-->
    ...
    <div class="content">
        <div class="header">
            ...
            <h1 class="page-title">简介管理</h1>
                    <ul class="breadcrumb">
            <li><a href="index.html">主面板</a> </li>
            <li class="active">简介管理</li>
        </ul>
...
<div class="btn-toolbar list-toolbar">
    <a href="add.php" class="btn btn-primary"><i class="fa fa-plus"></i> 添加简介</a>

</div>
<?php
    require '../../connect.php';
    $aData=mysql_query("select * from zxd_tem_tb_companyprofile");
    $arr=array();
  ...
  <tbody>
    <?php foreach ($arr as $value) { ?>
      <tr>
         ...
         <td><img width="30px" height="30px" src="../../admin/uploads/<?php echo $value['path']; ?>"><?php echo $value['path'];?></td>
         <!-- <td><?php echo $value['synopsiscontent'];?></td> -->
