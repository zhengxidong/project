  ...
  <!--<![endif]-->
    ...
    <div class="content">
        <div class="header">
            ...
            <h1 class="page-title">编辑联系</h1>
                    <ul class="breadcrumb">
            <li><a href="index.html">主面板</a> </li>
            <li class="active">编辑联系</li>
...
<?php
   ...
   {
    require '../../connect.php';
    $selectSql = "select * from zxd_tem_tb_contactus where id=".$_GET['id'];
    ...
    <div id="myTabContent" class="tab-content">
      ...
      <form action="update.php" method="post" id="tab">
        ...
        <label>地址</label>
         ...
         <textarea value="Smith" rows="3" name="address" class="form-control"><?php echo $arrData['address'];?></textarea>
        </div>
        <div class="form-group">
          <label>tel</label>
          <input type="text" name="tel" value="<?php echo $arrData['tel'];?>" class="form-control">
        </div>
        <div class="form-group">
          <label>传真</label>
         <input type="text" name="fax" value="<?php echo $arrData['fax'];?>" class="form-control">
        </div>
        <div class="form-group">
          <label>电子邮件</label>
         <input type="text" name="email" value="<?php echo $arrData['email'];?>" class="form-control">
        </div>
        <div class="form-group">
          <label>邮编</label>
         <input type="text" name="postcode" value="<?php echo $arrData['postcode'];?>" class="form-control">
        </div>
