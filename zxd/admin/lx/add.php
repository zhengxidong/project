...
<?php
   ...
   {
    require '../../connect.php';
    $insertSql="insert into zxd_tem_tb_contactus values(null ";
    $insertSql.=",'{$_POST['address']}'";
    $insertSql.=",'{$_POST['tel']}'";
    $insertSql.=",'{$_POST['fax']}'";
    $insertSql.=",'{$_POST['email']}'";
    $insertSql.=",'{$_POST['postcode']}')";
  ...
  <div class="col-md-4">
    ...
    <div id="myTabContent" class="tab-content">
      ...
      <form action="add.php" method="post" id="tab">
        ...
        <label>地址</label>
         <textarea value="Smith" rows="3" name="address" class="form-control"></textarea>
        </div>
        <div class="form-group">
          <label>tel</label>
