...
<div class="btn-toolbar list-toolbar">
    ...
    <a href="add.php" class="btn btn-primary"><i class="fa fa-plus"></i> 添加招聘</a>

</div>
<?php
    require '../../connect.php';

    $res = mysql_query("select count(*) total from zxd_tem_tb_recruitment");
    ...
    $start = ($page-1)*$show;
    $aData=mysql_query("select * from zxd_tem_tb_recruitment limit {$start},{$show}");
    $arr=array();
  ...
  <tbody>
    <?php foreach ($arr as $value) { ?>
      <tr>
         ...
         <td><?php echo $value['jobrequirements'];?></td>
         <td><?php echo $value['jobdate'];?></td>
         <td>
