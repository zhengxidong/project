...
<?php
   ...
   {
    require '../../connect.php';
    $insertSql="insert into zxd_tem_tb_news values(null ";
    $insertSql.=",'{$_POST['newstitle']}'";
    $insertSql.=",'{$_POST['newscontent']}'";
    $insertSql.=",now())";
  ...
  <div class="col-md-4">
    ...
    <div id="myTabContent" class="tab-content">
      ...
      <form action="add.php" method="post" id="tab">
        ...
        <div class="form-group">
          <label>内容</label>
          <textarea value="Smith" rows="3" name="newscontent" class="form-control"></textarea>
        </div>
       <!--  <div class="form-group">
         <label>发布时间</label>
