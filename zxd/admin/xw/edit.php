         ...
         <div class="form-group">
               <!--  <label for="dtp_input1" class="col-md-2 control-label">DateTime Picking</label> -->
                <div  class="input-group date form_datetime col-md-12" data-date="1979-09-16T05:25:07Z" data-date-format="yyyy-mm-dd HH:ii:ss" data-link-field="dtp_input1">
                    <input class="form-control" size="16" type="text" value="<?php echo $arrData['newsdate'];?>" readonly>
                    <span class="input-group-addon"><span class="glyphicon glyphicon-remove"></span></span>
                    <span class="input-group-addon"><span class="glyphicon glyphicon-th"></span></span>
                </div>
                <input type="hidden" name="newsdate" id="dtp_input1" value="<?php echo $arrData['newsdate'];?>" /><br/>
         </div>
        <div class="form-group">
        <label>标题</label>
        <input type="text" name="newstitle" value="<?php echo $arrData['newstitle'];?>" class="form-control">
        </div>
        <div class="form-group">
          <label>内容</label>
          <textarea value="Smith" rows="3" name="newscontent" class="form-control"><?php echo $arrData['newscontent'];?></textarea>
        </div>
        <!-- <div class="form-group">
          <label>发布时间</label>
          <input type="text" name="newsdate" value="<?php echo $arrData['newsdate'];?>" class="form-control">
        </div> -->
