    ...
    <div id="myTabContent" class="tab-content">
      ...
      <form action="update.php" method="post" id="tab" enctype="multipart/form-data">
         ...
         <div class="form-group">
               <!--  <label for="dtp_input1" class="col-md-2 control-label">DateTime Picking</label> -->
                <div  class="input-group date form_datetime col-md-12" data-date="1979-09-16T05:25:07Z" data-date-format="yyyy-mm-dd HH:ii:ss" data-link-field="dtp_input1">
                    <input class="form-control" size="16" type="text" value="<?php echo $arrData['productdate'];?>" readonly>
                    <span class="input-group-addon"><span class="glyphicon glyphicon-remove"></span></span>
                    <span class="input-group-addon"><span class="glyphicon glyphicon-th"></span></span>
                </div>
                <input type="hidden" name="productdate" id="dtp_input1" value="<?php echo $arrData['productdate'];?>" /><br/>
         </div>
         <div class="form-group">
          <label>名称</label>
           <input type="text" name="productname" value="<?php echo $arrData['productname'];?>" class="form-control">
        </div>
        <div class="form-group">
          <label>分类</label>
           <input type="text" name="classification" value="<?php echo $arrData['classification'];?>" class="form-control">
        </div>
        <div class="form-group">
        <label>图片路径</label>
       <!--  <input type="text" name="path" disabled="true" value="<?php echo $arrData['path'];?>" class="form-control"> -->
        ...
        <img width="100px" height="100px" src="../../productuploads/<?php echo $arrData['picpath'];?>">
        </div>
        <div class="form-group">
          <label>描述</label>
          <textarea value="Smith" rows="8" name="description" class="form-control"><?php echo $arrData['description'];?></textarea>
        </div>
        <!-- <div class="form-group">
          <label>发布时间</label>
           <input type="text" name="productdate" value="<?php echo $arrData['productdate'];?>" class="form-control">
        </div> -->
