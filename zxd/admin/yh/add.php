...
<?php
   if(!empty($_POST))
   {
    ...
    $file_extend = end($arr);
    $avatar = time().mt_rand(100,999999).".".$file_extend;
    move_uploaded_file($_FILES['avatar']['tmp_name'],'../../admin/avatarimg/'.$avatar);
    $insertSql="insert into tb_user values(null ";
    $insertSql.=",'{$avatar}'";
    $insertSql.=",'{$_POST['nickname']}'";
    $insertSql.=",'{$_POST['username']}'";
    $insertSql.=",'{$_POST['password']}'";
    $insertSql.=",'{$_POST['state']}')";
...
<div class="row">
  <div class="col-md-4">
    ...
    <div id="myTabContent" class="tab-content">
      ...
      <form action="add.php" method="post" id="tab" enctype="multipart/form-data">
        ...
        <div class="form-group">
          ...
          <option selected="selected">活动</option>
          <option>锁定</option>
          </select>
