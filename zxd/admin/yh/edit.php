...
<?php
   ...
   {
    require '../../connect.php';
    $selectSql = "select * from tb_user where id=".$_GET['id'];
  ...
  <div class="col-md-4">
    ...
    <div id="myTabContent" class="tab-content">
      ...
      <form action="update.php" method="post" id="tab" enctype="multipart/form-data">
        ...
        <img class="user" style="max-width:200px;max-height:200px;border-radius:200px;" src="../../avatarimg/<?php echo $arrData['avatar']; ?>">
        <input type="file" name="avatar" class="form-control">
        </div>
        <div class="form-group">
        <label>昵称</label>
        <input type="text" name="nickname" value="<?php echo $arrData['nickname'];?>" class="form-control">
        </div>
        <div class="form-group">
        <label>账号</label>
        <input type="text" name="username" value="<?php echo $arrData['username'];?>" class="form-control">
        </div>
        <div class="form-group">
          <label>密码</label>
           <input type="text" name="password" value="<?php echo $arrData['password'];?>" class="form-control">
        </div>
        <div class="form-group ">
          <label>状态</label>
          <select class= "form-control selectpicker " name="state" value="" data-style="btn-primary">
          <?php foreach ($arr as $value) {?>
          <?php if($value==$arrData['state'])
          { ?>
        ...
        <?php  } 
         ...
         <!--  <input type="text" name="state" value="<?php echo $arrData['state'];?>" class="form-control"> -->
        </div>
