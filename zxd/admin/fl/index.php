...
<body class=" theme-blue">
  ...
  <!--<![endif]-->
    ...
    <li><ul class="dashboard-menu nav nav-list collapse in">
            ...
            <li class="active"><a href="../fl/index.php"><span class="fa fa-caret-right"></span> 分类管理</a></li>
...
<div class="btn-toolbar list-toolbar">
    ...
    <a href="add.php" class="btn btn-primary"><i class="fa fa-plus"></i> 添加分类</a>

</div>
<?php
    require '../../connect.php';

    $res = mysql_query("select count(*) total from zxd_tem_tb_producttype");
    ...
    $start = ($page-1)*$show;
    $aData=mysql_query("select * from zxd_tem_tb_producttype limit {$start},{$show}");
    $arr=array();
