...
<body class=" theme-blue">
  ...
  <!--<![endif]-->
          ...
          <ul id="main-menu" class="nav navbar-nav navbar-right">
            <li class="dropdown hidden-xs">
              ...
              <ul class="dropdown-menu">
               ...
               <li class="divider"></li> -->
                <li><a tabindex="-1" href="loginout.php">注销</a></li>
              </ul>
            </li>
          </ul>
    ...
    <ul>
    <li data-popover="true"><a href="#" data-target=".dashboard-menu" class="nav-header" data-toggle="collapse"><i class="fa fa-fw fa-dashboard"></i> 主面板<i class="fa fa-collapse"></i></a></li>
